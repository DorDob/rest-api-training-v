...
@pytest.fixture()  # przed każdym testem wyczyszcza
def empty_db():  # wysyłam requesty - import bibloioteke requests
    requests.delete(
        pytest.HOST + "/accounts/delete",     
...
def _get_balance():
    r = requests.get(
        pytest.HOST + "/accounts", 
        params= {"account" : ACCOUNT_NAME}   #teraz z r wyciągam wartość pola, będę przeskakiwac z obiektu pola, do obiektu i pola...
    )
